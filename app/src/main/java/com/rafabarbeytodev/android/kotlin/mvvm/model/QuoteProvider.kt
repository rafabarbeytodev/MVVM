package com.rafabarbeytodev.android.kotlin.mvvm.model
/** Como primera opción crearemos un suministrador de datos para nuestro modelo, que en siguientes
entregas sustituiremos por retrofit, room, etc*/
class QuoteProvider {
    companion object {
